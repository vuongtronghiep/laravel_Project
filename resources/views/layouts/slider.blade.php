				...
				<div class="row">
					...
					<!-- SAID-BAR START -->
						<div class="side-bar"> 
							...
							<nav>
								<ul>
									<li><a href="category_grid.html"><span><i class="fa fa-male"></i></span>Nam <span class="right-icon"><i class="fa fa-arrow-circle-o-right"></i></span></a>
										<div class="category-mega-menu">
											<span class="menu-text">		
											@foreach($cate as $category)	
												@if($category['parent_id'] ==1 )				
													<a href="category_grid.html">{!! $category['category_name'] !!}</a>
												@endif
											@endforeach	
											</span>
											<span>
									...
									<li><a href="category_grid.html"><span><i class="fa fa-female"></i></span>Nữ <span class="right-icon"><i class="fa fa-arrow-circle-o-right"></i></span></a>
										<div class="category-mega-menu">
											<span class="menu-text">							
												@foreach($cate as $category)	
									...
									<li><a href="category_grid.html"><span><i class="fa fa-male"></i></span>Đồ Bé Trai <span class="right-icon"><i class="fa fa-arrow-circle-o-right"></i></span></a>
										<div class="category-mega-menu">
											<span class="menu-text">							
												@foreach($cate as $category)	
									...
									<li><a href="category_grid.html"><span><i class="fa fa-female"></i></span>Đồ Bé Gái <span class="right-icon"><i class="fa fa-arrow-circle-o-right"></i></span></a>
										<div class="category-mega-menu">
											<span class="menu-text">							
												@foreach($cate as $category)	
