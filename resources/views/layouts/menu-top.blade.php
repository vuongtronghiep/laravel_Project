										...
										<li><a href="category_grid.html"><span><i class="fa fa-shopping-cart"></i></span>Cửa hàng <i class="fa fa-arrow-circle-o-right"></i></a>
											<div class="mega-menu">
												<div class="single-mega-menu">
													...
													<a href="#">
														<i class="fa fa-arrow-circle-o-right"></i>Nam
													</a>
													<a href="#">
														<i class="fa fa-arrow-circle-o-right"></i>Nữ
													</a>
													<a href="#">
														<i class="fa fa-arrow-circle-o-right"></i>Đồ Bé Trai
													</a>
													<a href="#">
														<i class="fa fa-arrow-circle-o-right"></i>Đồ Bé Gái
													</a>
												</div>
												<div class="single-mega-menu">
